...
def run_imp_euler(dt: float, T: float) -> Tuple[ch.Energy, ch.TimeMarching]:
    ...
    implicit_euler: ch.VariationalImplicitEuler = ch.VariationalImplicitEuler(
...
output_folder: str = "log/implicit_euler_test/"
plt.figure("Energy")
