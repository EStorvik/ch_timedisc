...
class DoubleWell():
    ...
    This class implements the double well potential commonly used in phase field
    models and other applications. The potential is defined as:
    
    f(pf) = scaling * pf^2 * (1 - pf)^2
    
    The class also provides convenient functions for related potentials and their
    derivatives, useful for time discretization schemes.
    ...
    def __init__(self, scaling = 1.0):
        ...
        Args:
            scaling (float, optional): Scaling factor for the potential. Defaults to 1.0.
        """
